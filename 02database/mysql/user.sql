...
(
    ...
    `deleted`     boolean    not null default 0 comment '逻辑删除',
    index `idx_user_invite_key` (`user_id`),
    unique index `udx_invite_key` (`invite_key`, `delete_time`)
) engine = innodb
...
(
    ...
    `update_time` datetime not null default CURRENT_TIMESTAMP comment '更新时间',
    `deleted`     boolean  not null default 0 comment '逻辑删除',
    index idx_user (`user_id`, `until_time` desc)
) engine = innodb
...
(
    ...
    `deleted`       boolean  not null default 0 comment '逻辑删除',
    `delete_time`   datetime null comment '删除时间',
    unique index `udx_friend` (`user_id`, `friend_id`, `delete_time`)
) engine = innodb
...
(
    ...
    `update_time` datetime not null default CURRENT_TIMESTAMP comment '更新时间',
    `deleted`     boolean  not null default 0 comment '逻辑删除',
    unique index `udx_role_child` (`role_id`, `child_id`)
) engine = innodb
...
(
    ...
    `update_time`   datetime    not null default CURRENT_TIMESTAMP comment '更新时间',
    `deleted`       boolean     not null default 0 comment '逻辑删除',
    unique index `udx_role_permission` (`role_id`, `permission_id`),
    index idx_role_self (`role_id`, `self`)
) engine = innodb
...
(
    ...
    `update_time`   datetime    not null default CURRENT_TIMESTAMP comment '更新时间',
    `deleted`       boolean     not null default 0 comment '逻辑删除',
    unique index `udx_permission_relationships` (`ancestor_id`, `descendant_id`),
    index idx_descendant (`descendant_id`, `ancestor_id`),
    index idx_ancestor_adjoin (`ancestor_id`, `adjoin`)
) engine = innodb
